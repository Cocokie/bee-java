...
//            pluginPath = "/data/ftp/queen/99c1d2f4/20190129104303.jar";
            pluginPath = "/data/ftp/queen/b2e9fb60/20190215092644.jar";
            pluginClassInfo = "{\"instanceClass\":\"com.qdcz.plugin.InternetBDCollPlugin\"}";
        } else {
            logPath = args[0];
            beeId = args[1];
            pluginPath = args[2];
            ...
            System.out.println("beeId:"+beeId);
            System.out.println("pluginPath:"+pluginPath);
            System.out.println("pluginClassInfo:"+pluginClassInfo);
        }
